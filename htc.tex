...
\begin{frame}{\HTC\ \ Syntax}
  ...
  \item<3-> \structure{\HTC-formula} \ $\varphi$ \ over \ \Atoms\
    \begin{align*}
      \varphi \ ::= \ \bot \ \mid \ \ThAt\in\Atoms\ \mid \ \varphi \land \varphi \ \mid \  \varphi \lor \varphi \ \mid \  \varphi \rightarrow \varphi
    \end{align*}
  \item <4-> \structure{Notation} \
    For $a\in\Variables$ and $\boldsymbol{t}\in\Domain$,
    we abbreviate $(a=\boldsymbol{t})\in\Atoms$ by $a$.
  \end{itemize}
\end{frame}
% ----------------------------------------------------------------------
